...
/**
 * consul.exe agent -server -bootstrap -data-dir=data -bind=127.0.0.1 -client 0.0.0.0 -ui Created by windwant on 2016/8/18.
 */
public class ExampleTest {
    ...
    public static void registerService() {
        ...
        ImmutableRegistration immutableRegistration =
                ImmutableRegistration.builder().id("tomcat").name("tomcatSvr").addTags("container").address("119.254.118.122").port(8089).addChecks(immutableRegCheck).build();
    ...
    public static void check() {
        agentClient.register(8089, HostAndPort.fromParts("119.254.118.122", 8089), 1, "serviceName", "id-1", Collections.singletonList("tag2"), Collections.singletonMap("version", "1.1"));
