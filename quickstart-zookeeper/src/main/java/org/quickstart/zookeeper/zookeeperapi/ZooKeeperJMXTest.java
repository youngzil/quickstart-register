...
public class ZooKeeperJMXTest {
    ...
    public static void main(String[] args) throws IOException, MalformedObjectNameException, InstanceNotFoundException, IntrospectionException, ReflectionException {
        ...
        System.out.println("总编译时间 毫秒:" + getAttribute(mbsc, Compilation, "TotalCompilationTime"));// 总编译时间
                                                                                                  // 毫秒
        ...
        while (dataTreeIterator.hasNext()) {
            ...
            // 三个重置操作
            // ZooKeeperServer.resetLatency(); //重置min/avg/max latency
            // statistics
