...
/**
 * 拥有某种权限的zookeeper客户端，该权限与AuthZookeeper类的权限一致 多以AuthZookeeper类创建的节点，该客户端可以对该节点进行相应的操作(如：节点数据的获取：修改数据，删除数据等)
 * 
 * @author adai
 * @since 20170912 11:03
 *
 */
public class CorrectAuthZookeeper {
    private CountDownLatch countDownLatch = new CountDownLatch(1);
    private ZooKeeper zoo = null;

    public CorrectAuthZookeeper() {
        try {
