package org.quickstart.zookeeper.example.distribute.lock;
...
public class SimpleDistributedLockMutex extends BaseDistributedLock implements DistributedLock {
    ...
    /* (non-Javadoc)
     * @see org.quickstart.zookeeper.example.distribute.lock.DistributedLock#lock()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.quickstart.zookeeper.example.distribute.lock.DistributedLock#lock(long, java.util.concurrent.TimeUnit)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.quickstart.zookeeper.example.distribute.lock.DistributedLock#unLock()
     */
    @Override
