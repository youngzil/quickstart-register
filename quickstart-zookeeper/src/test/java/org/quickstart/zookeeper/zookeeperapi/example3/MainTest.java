 ...
 * 
 * @author adai
 * @since 20170912 10:46 测试zookeeper权限类
 */
public class MainTest {
    ...
    /**
     * correctAuthZookeeper得到节点对应的数据为:/testAuth: adai badAuthZookeeper获取数据失败：/testAuth---失败原因：KeeperErrorCode = NoAuth for /testAuth notAuthZookeeper获取数据失败：/testAuth---失败原因：KeeperErrorCode = NoAuth
     * for /testAuth
     */
    ...
    /**
     * correctAuthZookeeper:节点更新成功 /testAuth:auth correctAuthZookeeper badAuthZookeeper:节点更新失败 /testAuth:auth badAuthZookeeper---失败原因：KeeperErrorCode = NoAuth for /testAuth notAuthZookeeper:节点更新失败
     * /testAuth:auth notAuthZookeeper---失败原因：KeeperErrorCode = NoAuth for /testAuth
     */
    ...
    /**
     * AuthZookeeper:创建了一个具有相应权限的节点成功:/testAuth: adai correctAuthZookeeper:判断节点是否存在成功:/testAuth badAuthZookeeper:判断节点是否存在成功:/testAuth notAuthZookeeper:判断节点是否存在成功:/testAuth
     */
    ...
    /**
     * correctAuthZookeeper:创建了一个新的节点成功:/testAuth/children: adai children correctAuthZookeeper badAuthZookeeper:创建了一个新的节点失败:/testAuth/children: adai children badAuthZookeeper---失败原因:KeeperErrorCode =
     * NoAuth for /testAuth/children notAuthZookeeper:创建了一个新的节点失败:/testAuth/children: adai children notAuthZookeeper---失败原因:KeeperErrorCode = NoAuth for /testAuth/children
     */
    ...
    /**
     * correctAuthZookeeper:节点更新成功 /testAuth/children:set nodeData correctAuthZookeeper badAuthZookeeper:节点更新成功 /testAuth/children:set nodeData badAuthZookeeper notAuthZookeeper:节点更新成功
     * /testAuth/children:set nodeData notAuthZookeeper 疑问?为什么子节点会更新成功(请比较两个创建自己的方法有什么不同)
     */
     ...
     * badAuthZookeeper得到节点对应的数据为:/testAuth/children:set nodeData notAuthZookeeper notAuthZookeeper得到节点对应的数据为:/testAuth/children:set nodeData notAuthZookeeper
    ...
    /**
     * badAuthZookeeper:删除节点失败：/testAuth/children--失败原因：KeeperErrorCode = NoAuth for /testAuth/children notAuthZookeeper:删除节点失败：/testAuth/children--失败原因：KeeperErrorCode = NoAuth for /testAuth/children
    ...
    /**
     * 解决上文疑问 CorrectAuthZookeeper:创建了一个具有相应权限的节点成功:/testAuth/children2: adai all atuh create correctAuthZookeeper correctAuthZookeeper:节点更新成功 /testAuth/children2:set nodeData to AllAuth
     * correctAuthZookeeper badAuthZookeeper:节点更新失败 /testAuth/children2:set nodeData2 to AllAuth badAuthZookeeper ---失败原因：KeeperErrorCode = NoAuth for /testAuth/children2 notAuthZookeeper:节点更新失败
     * /testAuth/children2:set nodeData2 to AllAuth notAuthZookeeper ---失败原因：KeeperErrorCode = NoAuth for /testAuth/children2
     */
